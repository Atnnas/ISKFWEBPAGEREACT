                    ...
                    <div className="space-y-4 mb-2">
                        <div className="bg-white/5 border border-white/10 rounded-3xl p-6 relative group/info hover:border-white/20 transition-colors shadow-inner">
                            <div className="flex items-center justify-between">
                                <div className="text-left">
                                    <span className="block text-[10px] uppercase text-gray-500 font-bold tracking-[0.2em] mb-1">Provincia</span>
                        ...
                        {dojo.phone && (
                            <div className="bg-white/5 border border-white/10 rounded-3xl p-6 relative group/info hover:border-white/20 transition-colors shadow-inner">
                                <div className="flex items-center justify-between">
                                    <div className="text-left">
                                        <span className="block text-[10px] uppercase text-gray-500 font-bold tracking-[0.2em] mb-1">WhatsApp</span>
                                        <span className="text-xl font-black text-white italic">{dojo.phone}</span>
                                    </div>
                                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-white/10 to-transparent flex items-center justify-center border border-white/10 group-hover/info:bg-[#25D366]/20 text-gray-400 group-hover/info:text-[#25D366] transition-all shadow-lg">
                                        <svg className="w-6 h-6 fill-current transition-transform duration-500 group-hover/info:scale-110" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {dojo.address && (
                            <div className="bg-white/5 border border-white/10 rounded-3xl p-5 relative group/info hover:border-white/20 transition-colors shadow-inner">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 shrink-0 rounded-xl bg-gradient-to-br from-white/10 to-transparent flex items-center justify-center text-xl border border-white/10 group-hover/info:bg-orange-500/20 group-hover/info:text-orange-500 transition-all shadow-lg">
                                        📍
                                    </div>
                                    <div className="text-left w-full pr-2">
                                        <span className="block text-[10px] uppercase text-gray-500 font-bold tracking-[0.2em] mb-1">Dirección</span>
                                        {dojo.detailsUrl && dojo.detailsUrl !== "#" ? (
                                            <a href={dojo.detailsUrl} target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-white/90 leading-tight block hover:text-orange-400 transition-colors underline decoration-white/30 underline-offset-2">
                                                {dojo.address}
                                            </a>
                                        ) : (
                                            <span className="text-sm font-medium text-white/90 leading-tight block">{dojo.address}</span>
                                        )}
                                    </div>
                                </div>
                            </div>
                        ...
                        {dojo.email && (
                            <div className="bg-white/5 border border-white/10 rounded-3xl p-5 relative group/info hover:border-white/20 transition-colors shadow-inner">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 shrink-0 rounded-xl bg-gradient-to-br from-white/10 to-transparent flex items-center justify-center text-xl border border-white/10 group-hover/info:bg-yellow-500/20 group-hover/info:text-yellow-500 transition-all shadow-lg">
                                        ✉️
                                    </div>
                                    <div className="text-left w-full pr-2">
                                        <span className="block text-[10px] uppercase text-gray-500 font-bold tracking-[0.2em] mb-1">Correo Electrónico</span>
                                        <a href={`mailto:${dojo.email.split(' / ')[0]}`} className="text-sm font-medium text-white/90 leading-tight block hover:text-yellow-400 transition-colors truncate max-w-[200px]" title={dojo.email}>
                                            {dojo.email}
                                        </a>
                                    </div>
                                </div>
                        ...
                        {dojo.website && (
                            <div className="bg-white/5 border border-white/10 rounded-3xl p-5 relative group/info hover:border-white/20 transition-colors shadow-inner">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 shrink-0 rounded-xl bg-gradient-to-br from-white/10 to-transparent flex items-center justify-center text-xl border border-white/10 group-hover/info:bg-purple-500/20 group-hover/info:text-purple-500 transition-all shadow-lg">
                                        🌐
                                    </div>
                                    <div className="text-left w-full pr-2">
                                        <span className="block text-[10px] uppercase text-gray-500 font-bold tracking-[0.2em] mb-1">Sitio Web</span>
                                        <a href={dojo.website} target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-white/90 leading-tight block hover:text-purple-400 transition-colors truncate max-w-[200px]" title={dojo.website}>
                                            Visitar Web Externo
                                        </a>
                                    </div>
                                </div>
        ...
        >
            ...
            >
                ...
                {dojo.logo ? (
                    ...
                    <div className="w-full h-full p-2 flex flex-col items-center justify-center relative z-20 transition-transform duration-700 group-hover:scale-110">
                        <span className="text-[10px] md:text-[11px] font-black uppercase text-center text-white leading-tight drop-shadow-md">
                            {dojo.name.replace('❗ ', '')}
                        </span>
                        {!isExpanded && <span className="text-[8px] text-iskf-red mt-1 uppercase font-bold animate-pulse">Sin Logo</span>}
                    </div>
                )}
